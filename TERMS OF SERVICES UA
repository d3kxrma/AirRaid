...
Додаток - надане Компанією програмне забезпечення, завантажене Вами на будь-який електронний пристрій під назвою Air Raid

Магазин додатків означає службу цифрової дистрибуції, що експлуатується та розробляється Apple Inc. (Apple App Store) або Google Inc. (Google Play Store), в якій було завантажено Додаток.

Афілійована особа означає особу, яка контролює, контролюється або перебуває під спільним контролем зі стороною, де "контроль" означає володіння 50% або більше акцій, паїв або інших цінних паперів, що дають право голосу при обранні директорів або інших керівних органів.
